      ...
      <div class="container">
        ...
        <div class="youtube__cont">
          <form @submit.prevent="SearchMovies()" class="search-box">
            <div class="search">
              <label class="sr-only">검색하기</label>
              <input type="search" placeholder="검색하기" v-model="search" />
  ...
  setup() {
    ...
    const SearchMovies = () => {
      if (search.value != "") {
        ...
        fetch(
          `https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=32&q=${search.value}&type=video&key=AIzaSyAuTqa0-EWmo7QcS0lDxPVE45QJSRE1pp0`
        )
